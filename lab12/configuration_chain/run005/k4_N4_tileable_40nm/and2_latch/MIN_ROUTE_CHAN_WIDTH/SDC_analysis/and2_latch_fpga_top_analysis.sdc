...
#	Date: Wed Aug 16 11:54:48 2023
#############################################

##################################################
# Create clock                                    
##################################################
create_clock clk[0] -period 9.405719537e-10 -waveform {0 4.702859768e-10}

##################################################
# Create input and output delays for used I/Os    
##################################################
set_input_delay -clock clk[0] -max 9.405719537e-10 gfpga_pad_GPIO_PAD[15]
set_input_delay -clock clk[0] -max 9.405719537e-10 gfpga_pad_GPIO_PAD[30]
set_output_delay -clock clk[0] -max 9.405719537e-10 gfpga_pad_GPIO_PAD[12]
set_output_delay -clock clk[0] -max 9.405719537e-10 gfpga_pad_GPIO_PAD[26]
